...
[GitHub Releases page](https://github.com/gleachkr/Lectic/releases). Make it
...
[GitHub Releases page](https://github.com/gleachkr/Lectic/releases) and put
it on your PATH.
...
stores tokens at `$LECTIC_STATE/chatgpt_auth.json`.
