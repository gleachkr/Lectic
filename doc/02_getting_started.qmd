...
To enable it, source the completion script in your shell configuration (e.g.,
`~/.bashrc`):
...
or place the script in `~/.local/share/bash-completion/completions/` or one of
the other standard locations for completion scripts.
