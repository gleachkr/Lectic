...
- Output of `:attach[...]` directives (`kind="attach"`)
...
For `:attach[...]`, `<command>` is empty and `<content>` is the verbatim
text from the directive.
...
need to re-run a command, just run `lectic` again with the same `:cmd`
