...
Hook commands run synchronously. Their stdout, stderr, and exit status are
ignored by Lectic. Use your own logging inside the hook if you want persistent records.
