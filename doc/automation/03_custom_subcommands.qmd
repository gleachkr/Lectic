...
Lectic includes a built-in bun runtime for running JavaScript and TypeScript files via
`lectic script`. You can use this to write subcommands in JS or TS even if you
don't have bun installed globally.
...
Bun has built in support for [all sorts of things](https://bun.com/docs),
including YAML parsing and serialization, running simple webservers,
interfacing with databases, rich networking primitives, and lots more. All
these are accessible via `lectic script`.
