...
This recipe demonstrates advanced macro techniques. Most Lectic workflows
don't need recursive macros or control flow constructs—a simple `exec`
tool or script usually suffices. But if you want to see how far the macro
system can go, read on.
:::
