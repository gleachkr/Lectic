...
- `-I`, `--Include <PATH>`
  Include an additional YAML file whose contents are merged into the active
  configuration. Higher precedence than system and working‑directory config,
  lower than the `.lec` header.
