...
Lectic uses an XML block for tool calls. This is the canonical and only
supported form. The opening tag names the tool, and the block contains two
children: an <arguments> element and a <results> element.
