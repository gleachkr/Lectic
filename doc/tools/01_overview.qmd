...
bundle once and reference it by name in each interlocutor. Bundles are
...
interlocutor:
  ...
  prompt: You are a helpful assistant.
  tools:
    - bundle: typescript_tools
```

You can still mix regular tools alongside bundle references.
